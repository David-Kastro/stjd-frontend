...
const PDFViewerScroll = ({ linkPdf }: PDFViewerProps) => {
  ...
  return (
    <div className="relative rounded-[1.375rem] bg-[#E1E1E1] lg:px-[1.69rem]">
      ...
      <div>
        <div
          className="scroll-custom-editais mx-auto mt-[1rem] flex max-h-[56vh] w-[20rem] justify-center overflow-y-scroll border border-gray-300 bg-white shadow-lg lg:w-full lg:max-w-[46rem] lg:p-2"
