  ...
  return (
    <>
      <section>
        <CardTopPage
          title="Suplentes"
          description="Os suplentes são membros do Tribunal Pleno que preenchem as vagas dos auditores quando necessário. Eles são escolhidos pelo Tribunal Pleno e são designados para preencher as vagas dos auditores."
          image={WoodenGavel}
          scrollTo="#members"
