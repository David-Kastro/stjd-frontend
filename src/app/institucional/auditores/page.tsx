...
function Auditores() {
  ...
  return (
    <>
      ...
      <section
        id="members"
        className="container relative pt-6 lg:ml-auto lg:mr-[unset] min-[2000px]:mr-auto lg:pl-8 lg:before:absolute lg:before:inset-y-0 lg:lg:before:left-4 lg:before:h-full lg:before:w-[2px] lg:before:bg-border"
      >
