...
const presidentes: Presidente[] = [
  ...
  {
    id: 2,
    nome: 'JOÃO COELHO BRANCO',
    periodoInicio: 1946,
    periodoFim: 1947,
    foto: '/images/joao-coelho-branco.jpg',
  },
  {
    id: 3,
    nome: 'JURANDIR LODI',
  ...
  },
  {
    ...
    periodoInicio: 2012,
    periodoFim: 2014,
    foto: '/images/flavio.jpg',
  },
  {
    id: 18,
    nome: 'CAIO CÉSAR ROCHA ',
    periodoInicio: 2014,
    periodoFim: 2016,
    foto: '/images/caio-cesar.jpg',
  },
  {
    id: 19,
    nome: 'RONALDO PIACENTE',
    periodoInicio: 2016,
    periodoFim: 2018,
    foto: '/images/ronaldo-botelho.jpg',
  },
  {
    id: 20,
