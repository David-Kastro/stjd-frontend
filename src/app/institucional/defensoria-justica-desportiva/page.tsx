...
const orgaoCodes: Record<string, string> = {
  DJD: 'Defensoria de Justiça Desportiva',
}

export const revalidate = 10

async function Defensoria() {
  ...
  return (
    <>
      <section>
        <CardTopPage
          title="Defensoria de Justiça Desportiva"
      ...
      >
        ...
        <div className="mt-24">
          <TeamGrid
            teamsData={[{ title: 'Defensoria', members: [attorneyLeader] }]}
            hideDividers
          />
