...
function Transparencia() {
  ...
  return (
    <div className="container mt-[5.57rem]">
      <div className="lg:border-l-[2px]">
        <div className="mx-auto flex w-full max-w-[100.82681rem] items-center gap-[2.94rem]">
          ...
          <div className="grid w-full grid-cols-4 gap-x-[1.1rem] gap-y-[1.58rem]">
        ...
        <div className="mx-auto w-full max-w-[100.82681rem]">
          <hr className="mb-[4.31rem] mt-[3.15rem] h-[0.125rem] bg-secondary"></hr>
          <ScaleAttorneys
            ...
            href=""
          />
          <div className="mt-[8rem] bg-[#000] py-[3.87rem] lg:container lg:bg-transparent lg:py-0">
