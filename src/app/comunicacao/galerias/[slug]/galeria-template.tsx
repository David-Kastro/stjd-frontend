...
export function GaleriaTemplate({
  galeria,
  filters,
}: {
  galeria: Galeria
  ...
  return (
    <div>
      <div className="container mt-8 lg:mt-[7.95rem]">
          ...
          <div className="container">
            <div className="relative z-10 mx-auto mt-[2.56rem] max-w-[100.0625rem]">
              ...
              <div className="mt-[4.16rem] flex items-center justify-center gap-[0.56rem]">
                ...
                >
                  <CarouselContent>
                    {galeria.imagens.map((img: any, index: number) => (
